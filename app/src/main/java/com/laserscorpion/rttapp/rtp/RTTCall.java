...
/**
 * <p>RTTcall is one of the core classes, establishing the RTP session and interfacing with Omnitor's
 ...
 * need to call such methods as getInviteTransaction() or getCreationEvent().</p>
 */
